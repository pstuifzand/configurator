    ...
    public function getChoices($choicesId)
    {
        return [
            ...
            new Choice("Kies het eindformaat", [
                ...
                new Option('A5', 0, 0),
                new Option('A6', 0, 0),
                new Option('Lang A5', 0, 0),
                new Option('Vierkant (210mm x 210mm)', 0, 0),
                new Option('Vierkant (135mm x 135mm)', 0, 0),
            ], 'size'),
            new Choice('Kies de vouwrichting', [
                new Option('Staand', 0, 0),
                new Option('Liggend', 0, 0),
            ], 'fold_direction'),
            new Choice('Aantal pagina\'s inclusief omslag', [
                new Option('8 Pagina\'s', 0, 0),
                new Option('12 Pagina\'s', 0, 0),
                new Option('16 Pagina\'s', 0, 0),
                new Option('20 Pagina\'s', 0, 0),
                new Option('24 Pagina\'s', 0, 0),
                new Option('28 Pagina\'s', 0, 0),
            ], 'page_count'),
